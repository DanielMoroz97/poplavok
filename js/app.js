...
let searchSelect = document.querySelector('.search-page__tittle');
let categoriesSearch = document.querySelector('.categorias-search');
...
let checkboxCategories = document.querySelectorAll('.categorias-search__checkbox');
